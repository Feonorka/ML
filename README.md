...
# Урок 9
### Задача МО:
[Урок 1] (# Урок 1) Получение **целевого значения** - некоторого идеального состояния данных, идеального предсказания, которое данные должны принять. Это может быть либо среднее значение, дибо некоторое ожидаемое значение.
### Проблема модели МО:
